...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个程序员, Hi，我是一个打工人,分享一些好玩有趣的东西,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'LQ联启', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '分享一些好玩有趣的东西', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.207207.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'LQ Blog,联启博客', // 网站关键词 英文逗号隔开
